// src/features/otherservices/activation/ActivationScratchContent.tsx
import React from "react";

// --- IMPORT ẢNH ---
import introActivationScratchImg from "../../../assets/printingservices/intro-hardbox.png";

export const ActivationScratchContent: React.FC = () => {
  return (
    // Section Container
      ...
      <div className="flex flex-col items-center mt-[20px] md:mt-[50px] xl:mt-[100px] w-full px-4 xl:px-0">
        ...
        >
          <span className="text-[32px] md:text-[40px] xl:text-[50px]">
            Thông Tin Dịch Vụ In Thẻ Cào Kích Hoạt Dịch Vụ
          </span>
        </h2>
