// src/features/coreservices/publication/PublicationContent.tsx
import React from "react";

// --- IMPORT ẢNH ---
import introPublicationImg from "../../../assets/printingservices/intro-hardbox.png";
      ...
      <div className="flex flex-col items-center mt-[20px] md:mt-[50px] xl:mt-[100px] w-full px-4 xl:px-0">
        ...
        >
          <span className="text-[32px] md:text-[40px] xl:text-[50px]">
            Thông Tin Dịch Vụ In Ấn Phẩm Marketing
          </span>
        </h2>
