  ...
  return (
    <section
      ...
      style={{
        width: "1379px",
        height: "451px",
        marginTop: "40px", // Khoảng cách từ Header xuống
      }}
    >
      {/* 1. Title Section */}
      <div className="mt-[56px] text-center flex flex-col items-center">
        ...
        >
          Khẳng định nội dung có giá trị chuyên môn cao. Nơi tìm kiếm giải pháp
          và tiêu chuẩn in ấn B2B.
        </p>
      </div>
      ...
      <div
        className="absolute"
        style={{
          top: "347px", // Vị trí tuyệt đối theo Figma
          width: "749.72px",
          height: "0px",
      ...
      <div
        ...
        style={{
          top: "370px", // Vị trí tuyệt đối theo Figma
          gap: "40px", // Khoảng cách giữa nhóm Phone và Mail
        }}
      >
        {/* Phone Group */}
