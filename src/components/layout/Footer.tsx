...
export const Footer = () => {
  ...
  return (
    <footer className="w-full flex flex-col items-center font-sans text-promac-black bg-white overflow-x-hidden">
      {/* === SECTION 1: CTA & BANNER === */}
      <div className="w-full max-w-[1440px] pt-[31px] pb-20 flex flex-col items-center relative z-10 bg-white">
