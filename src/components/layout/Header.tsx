  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 w-full flex justify-center z-50 bg-white shadow-sm font-inter">
        ...
        {/* 2. DESKTOP HEADER */}
        <header className="hidden xl:flex items-center justify-between w-full max-w-[1440px] h-[110px] px-[20px] xl:px-[40px]">
        ...
        {mobileMenuOpen && (
          <div className="fixed top-[72px] md:top-[80px] left-0 w-full h-[calc(100vh-72px)] md:h-[calc(100vh-80px)] bg-white z-40 xl:hidden overflow-hidden border-t border-[#E3E7EF]">
            {/* VIEW 1: MAIN MENU */}
            <div
              className={cn(
      ...
      {/* --- KHỐI ĐỆM (SPACER) ĐỂ ĐẨY NỘI DUNG XUỐNG --- */}
      {/* Chiều cao của khối này phải khớp với chiều cao của Header ở từng breakpoint */}
      {/* Mobile: 72px, Tablet: 80px, Desktop: 110px */}
      <div className="w-full h-[72px] md:h-[80px] xl:h-[110px]" />
    </>
  );
};
